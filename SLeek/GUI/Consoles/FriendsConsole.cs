...
namespace SLeek
{
    public partial class FriendsConsole : UserControl
    {
        ...
        {
            instance.TabConsole.AddIMTab(selectedFriend.UUID, client.Self.SessionID ^ selectedFriend.UUID, selectedFriend.Name);
            instance.TabConsole.SelectTab(selectedFriend.Name);
        }
